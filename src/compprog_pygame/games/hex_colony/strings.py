...
TUTORIAL_STEPS: list[dict[str, object]] = [
    {
        ...
        "lines": [
            ...
            "Your crew needs Food to survive \u2014 without it your colonists will starve!",
            "",
    ...
    },
    {
        ...
        "lines": [
            "Left-click a tile or building to see info about it in the side panel.",
            "",
            "Use WASD or hold middle-click (or right-click on empty space) and drag to pan the camera. Scroll to zoom. Middle-click also pans menus that scroll.",
            "",
            "Right-click to cancel build mode or clear your current selection.",
        ],
    },
    {
        "id": "build_gatherer",
        ...
        "lines": [
            "Open the Buildings tab at the bottom of the screen, switch to the Resource subtab, then pick the Gatherer.",
            "",
            "Place it on a fiber patch tile \u2014 green ground covered with red-berry bushes, like the example below.",
            "",
    ...
    },
    {
        ...
        "lines": [
            "Your Gatherer needs a path connection to the Camp so workers can reach it.",
            "",
            "Open the Buildings tab, switch to the Logistics subtab, and pick Path. Click near the Camp, then click near the Gatherer to lay a route automatically.",
        ],
    },
    {
        "id": "food_producing",
